...
async def ocr(event):
    catevent = await edit_or_reply(event, "`Leyendo...`")
    ...
    try:
        ...
        await catevent.edit("`Lo siento, no puedo leer eso...`\n`Supongo que necesito lentes nuevos.`")
    else:
        await catevent.edit(f"`Esto es lo que pude leer de esa foto:`\n\n{ParsedText}")
